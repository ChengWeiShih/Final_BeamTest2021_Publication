...
// note : titles_vec[0] : x
// note : titles_vec[1] : y
void dataMC_comp (TH1D* hist_data, TH1D* hist_MC, TString folder_direction, TString plot_name, vector<TString> titles_vec ,bool linear_or_log = false, bool statsbox_bool = false)
{

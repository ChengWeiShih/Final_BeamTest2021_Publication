...
std::string data_input_directory = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/Final_BeamTest2021_Publication/data/Run71";
std::string data_input_filename = "run71_no_clone_filter_all_clusters.root";
std::string data_output_directory = data_input_directory + "/DetectionEffi_baseline700um";

std::tuple<std::string, double, double, double> Run71_mother(
    ...
    DetectionEffiAna * Run71Data = new DetectionEffiAna(
        true,
        71,
    ...
    Run71Data -> Get_l1_alignment();
    Run71Data -> Get_l0l2_slope();
    Run71Data -> GetDetectionEffi(
    ...
    return {
        Run71Data -> GetOutputFileName(),
        Run71Data -> Get_Final_Effi()[0],
        Run71Data -> Get_Final_Effi()[1],
        Run71Data -> Get_Final_Effi()[2]
    };
}
...
int Run71() {
    ...
    int    BaseLine_Selected_Column = 9; // note : 1 to 13,
    ...
    // Division: BaseLine ---------------------------------------------------------------------------------
    std::tuple<std::string, double, double, double> tuple_BaseLine = Run71_mother(

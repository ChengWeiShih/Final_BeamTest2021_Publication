...
std::string data_input_directory = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/Final_BeamTest2021_Publication/data/Run76";
std::string data_input_filename = "run76_no_clone_filter_all_clusters.root";
std::string data_output_directory = data_input_directory + "/DetectionEffi_baseline700um";

std::tuple<std::string, double, double, double> Run76_mother(
    ...
    DetectionEffiAna * Run76Data = new DetectionEffiAna(
        true,
        76,
    ...
    Run76Data -> Get_l1_alignment();
    Run76Data -> Get_l0l2_slope();
    Run76Data -> GetDetectionEffi(
    ...
    return {
        Run76Data -> GetOutputFileName(),
        Run76Data -> Get_Final_Effi()[0],
        Run76Data -> Get_Final_Effi()[1],
        Run76Data -> Get_Final_Effi()[2]
    };
}
...
int Run76() {
    ...
    // Division: BaseLine ---------------------------------------------------------------------------------
    std::tuple<std::string, double, double, double> tuple_BaseLine = Run76_mother(
